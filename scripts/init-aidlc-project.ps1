...
Write-Host ""
Write-Host "Optional - Set up Outline for non-technical reviewers:"
Write-Host "  1. cd outline && cp .env.example .env (then edit .env)"
Write-Host "  2. docker compose up -d"
Write-Host "  3. Create API key at http://localhost:3000/settings/api"
Write-Host "  4. pip install -r scripts/requirements.txt"
Write-Host "  5. python scripts/sync-outline.py init"
Write-Host "  See docs/design/outline-integration.md for details."
Write-Host ""
